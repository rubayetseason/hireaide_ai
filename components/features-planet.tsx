        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              How HireAide.ai Empowers Your Hiring Process
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                ◦ Generate role-specific interview questions tailored to job
                requirements.
              </p>
              <p className="text-[15px] text-gray-400">
                ◦ Provide real-time insights and feedback during interviews for
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Level 1 Candidate Validation</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                ◦ Verify LinkedIn profiles, certifications, and employment
                history to ensure credibility.
              </p>
              <p className="text-[15px] text-gray-400">
                ◦ Automate pre-screening and reference checks, saving time and
                effort.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Unbiased and Data-Driven Hiring</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                ◦ Use AI to evaluate candidates objectively, minimizing
                unconscious bias.
              </p>

              <p className="text-[15px] text-gray-400">
                ◦ Standardize evaluations with AI-driven scoring and analytics.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                ◦ Automate repetitive tasks, such as note-taking and candidate
                comparison.
              </p>

              <p className="text-[15px] text-gray-400">
                ◦ Integrate seamlessly with existing ATS and HR tools for a
                unified experience.
              </p>
            </article>
          </div>
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Automate time-consuming tasks to focus on high-impact
                decision-making.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Standardize evaluations and ensure unbiased candidate selection.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Validate profiles and credentials to ensure credible hiring
                decisions.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Enhanced Candidate Experience</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Deliver a professional, structured, and engaging hiring process.
              </p>
            </article>
          </div>
        </div>
